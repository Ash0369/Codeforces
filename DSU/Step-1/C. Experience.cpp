...
{
    public:
    vector<ll int>rank,parent,size,point,extra;
    dsu(int n)
    {
    ...
    int find_parent(int node)
    {
        ...
        return find_parent(parent[node]);//Path compression
    }
    void union_by_size(int u,int v)
    {
        ...
        else if(size[ultimate_parent_u]<=size[ultimate_parent_v])
        {
            ...
            extra[ultimate_parent_u]=point[ultimate_parent_v];
        }
        else if(size[ultimate_parent_u]>size[ultimate_parent_v])
        {
            parent[ultimate_parent_v]=ultimate_parent_u;
            size[ultimate_parent_u]+=size[ultimate_parent_v];
            extra[ultimate_parent_v]=point[ultimate_parent_u];
        }
        else if(size[ultimate_parent_u]==size[ultimate_parent_v])
        {
            parent[ultimate_parent_v]=ultimate_parent_u;
    ...
    ll int get(int x)
    {
        ...
        return point[x]-extra[x]+get(parent[x]);
    }
